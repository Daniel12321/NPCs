...
import me.mrdaniel.npcs.catalogtypes.options.types.OptionLlamaType;
...
import me.mrdaniel.npcs.catalogtypes.options.types.OptionParrotType;
...
public final class OptionTypes {
	...
	public static final OptionType<LlamaVariant> LLAMATYPE = new OptionLlamaType();
	...
	public static final OptionType<ParrotVariant> PARROTTYPE = new OptionParrotType();
