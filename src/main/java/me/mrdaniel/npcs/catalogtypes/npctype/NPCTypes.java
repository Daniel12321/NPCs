...
public class NPCTypes {
	...
	public static final NPCType CHICKEN = new NPCType("Chicken", "chicken", EntityTypes.CHICKEN, true);
	public static final NPCType COW = new NPCType("Cow", "cow", EntityTypes.COW, true);
	public static final NPCType CREEPER = new NPCType("Creeper", "creeper", EntityTypes.CREEPER);
	public static final NPCType DONKEY = new NPCType("Donkey", "donkey", EntityTypes.DONKEY, true);
	...
	public static final NPCType HORSE = new NPCType("Horse", "horse", EntityTypes.HORSE, true);
	public static final NPCType HUMAN = new NPCType("Human", "human", EntityTypes.HUMAN, false, true);
	public static final NPCType HUSK = new NPCType("Husk", "husk", EntityTypes.HUSK, true, true);
	...
	public static final NPCType LLAMA = new NPCType("Llama", "llama", EntityTypes.LLAMA, true);
	public static final NPCType MAGMA_CUBE = new NPCType("MagmaCube", "magma_cube", EntityTypes.MAGMA_CUBE);
	public static final NPCType MULE = new NPCType("Mule", "mule", EntityTypes.MULE, true);
	public static final NPCType MUSHROOM_COW = new NPCType("MushroomCow", "mushroom_cow", EntityTypes.MUSHROOM_COW, true);
	public static final NPCType OCELOT = new NPCType("Ocelot", "ocelot", EntityTypes.OCELOT, true, false, true);
	public static final NPCType PARROT = new NPCType("Parrot", "parrot", EntityTypes.PARROT);
	public static final NPCType PIG = new NPCType("Pig", "pig", EntityTypes.PIG, true);
	public static final NPCType PIG_ZOMBIE = new NPCType("PigZombie", "pig_zombie", EntityTypes.PIG_ZOMBIE, true, true);
	public static final NPCType POLAR_BEAR = new NPCType("Polarbear", "polar_bear", EntityTypes.POLAR_BEAR, true);
	public static final NPCType RABBIT = new NPCType("Rabbit", "rabbit", EntityTypes.RABBIT, true);
	public static final NPCType SHEEP = new NPCType("Sheep", "sheep", EntityTypes.SHEEP, true);
	...
	public static final NPCType SKELETON = new NPCType("Skeleton", "skeleton", EntityTypes.SKELETON, false, true);
	public static final NPCType SKELETON_HORSE = new NPCType("SkeletonHorse", "skeleton_horse", EntityTypes.SKELETON_HORSE, true);
	...
	public static final NPCType STRAY = new NPCType("Stray", "stray", EntityTypes.STRAY, false, true);
	public static final NPCType VEX = new NPCType("Vex", "vex", EntityTypes.VEX);
	public static final NPCType VILLAGER = new NPCType("Villager", "villager", EntityTypes.VILLAGER, true);
	...
	public static final NPCType WITHER_SKELETON = new NPCType("WitherSkeleton", "wither_skeleton", EntityTypes.WITHER_SKELETON, false, true);
	public static final NPCType WOLF = new NPCType("Wolf", "wolf", EntityTypes.WOLF, true, false, true);
	public static final NPCType ZOMBIE = new NPCType("Zombie", "zombie", EntityTypes.ZOMBIE, true, true);
	public static final NPCType ZOMBIE_HORSE = new NPCType("ZombieHorse", "zombie_horse", EntityTypes.ZOMBIE_HORSE, true);
	public static final NPCType ZOMBIE_VILLAGER = new NPCType("ZombieVillager", "zombie_villager", EntityTypes.ZOMBIE_VILLAGER, true, true);
