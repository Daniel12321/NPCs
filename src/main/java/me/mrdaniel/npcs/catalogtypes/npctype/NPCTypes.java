...
public class NPCTypes {
	...
	public static final NPCType OCELOT = new NPCType("Ocelot", "ocelot", EntityTypes.OCELOT, true, false);
	...
	public static final NPCType WOLF = new NPCType("Wolf", "wolf", EntityTypes.WOLF, true, false);
