...
public class OnlyOnceActions extends ListActions {

	public OnlyOnceActions(@Nonnull final List<Action> actions, @Nonnull final Map<UUID, Integer> current) {
		super("only_once", actions, current);
	}
